...
def centralized_sgd(setting, attack=None, save_model=False, save_results=False):
    ...
    if args.attack == sign_flipping:
        file_name = 'sign_flipping/RSAGau_user[{}]_byzanusers[{}]_duli{}_lr[{}]_eps[{}].pkl'. \
            format(args.num_users, args.byzantinue_users, args.iid, args.lr,
                   args.eps)

    elif args.attack == same_value:
        file_name = 'same_value/RSAGau_user[{}]_byzanusers[{}]_duli{}_lr[{}]_eps[{}].pkl'. \
            format(args.num_users, args.byzantinue_users, args.iid, args.lr,
                   args.eps)

    elif args.attack == gauss_attack:
        file_name = 'gauss_attack/RSAGau_user[{}]_byzanusers[{}]_duli{}_lr[{}]_eps[{}].pkl'. \
            format(args.num_users, args.byzantinue_users, args.iid, args.lr,
                   args.eps)

    elif args.attack == zero_gradient:
        file_name = 'zero_gradient/RSAGau_user[{}]_byzanusers[{}]_duli{}_lr[{}]_eps[{}].pkl'. \
            format(args.num_users, args.byzantinue_users, args.iid, args.lr,
                   args.eps)

    elif args.attack == sample_duplicating:
        file_name = 'sample_duplicating/RSAGau_user[{}]_byzanusers[{}]_duli{}_lr[{}]_eps[{}].pkl'. \
            format(args.num_users, args.byzantinue_users, args.iid, args.lr,
                   args.eps)
